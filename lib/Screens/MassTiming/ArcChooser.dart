...
class ChooserState extends State<ArcChooser>
  ...
  void initState() {
    ...
    arcItems.add(ArcItem("Rosary", [Color(0xFFF9D976), Color(0xfff39f86)],
        angleInRadiansByTwo + userAngle));
    arcItems.add(ArcItem("Eucharistic", [Color(0xFF21e1fa), Color(0xff3bb8fd)],
        angleInRadiansByTwo + userAngle + (angleInRadians)));
    arcItems.add(ArcItem("Weekend", [Color(0xFF3ee98a), Color(0xFF41f7c7)],
        angleInRadiansByTwo + userAngle + (2 * angleInRadians)));
    arcItems.add(ArcItem("Weekday", [Color(0xFFfe0944), Color(0xFFfeae96)],
